...
class CreateProductionIssuedItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('production_issued_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('production_issued_items');
    }
}

        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                  <h4 class="card-title">
                    All Receiving Order list <a href="{{ route('job-order.receiving.create') }}" class="btn btn-sm btn-primary float-end"><i
                ...
                <div class="card-body">
                  <table class="table table-striped dt-responsive nowrap" id="dataTable" style="width:100%">
                    ...
                    <tbody>
                      @foreach ($receivingOrderLists as $receivingOrderList)
                      <tr>
                        <td>#{{ $receivingOrderList->order_id }} [{{ $receivingOrderList->jobOrder->order_no_manual }}]</td>
                        <td>{{ $receivingOrderList->product->model_name }} [{{ $receivingOrderList->product->product_name }}]</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li><a class="dropdown-item" href="{{ route('job-order.receiving.create', ['order_id' => $receivingOrderList->order_id, 'product_id' => $receivingOrderList->product_id]) }}">Edit</a></li>
                            </ul>
                          </div>
...
<script>
  $(document).ready(function() {
    var exportTitle = 'receiving-order-lists-data-export-' + Date.now();

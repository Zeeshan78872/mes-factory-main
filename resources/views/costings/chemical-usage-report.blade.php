...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-calculator"></i> Chemical Usage Report</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                                ...
                                <table class="table table-striped dt-responsive nowrap" id="dataTable" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $result->order_no_manual }}</td>
                                            <td>{{ $result->P3_model_name }}</td>
...
<script>
  ...
  $('.ajax-job-orders').select2(ajaxJobOrdersOptions);
    ...
    var exportTitle = 'chemical-usage-report-data-export-' + Date.now();

        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                  <h4 class="card-title">
                    All Products Categories <a href="{{ route('product.categories.create') }}" class="btn btn-sm btn-primary float-end"><i class="fa fa-plus"></i> Add New</a>
                  </h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table class="table table-striped dt-responsive nowrap" id="dataTable" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="{{ route('product.categories.show', $category->id) }}">{{ $category->id }}</a></td>
                        <td>{{ $category->name }}</td>
                        <td>{{ $category->code }}</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li><a class="dropdown-item" href="{{ route('product.categories.show', $category->id) }}">View</a></li>
                              <li><a class="dropdown-item" href="{{ route('product.categories.edit', $category->id) }}">Edit</a></li>
                              <li><a class="dropdown-item" href="#!" onclick="callDeletItem('{{ $category->id }}', 'product/categories');">Delete</a></li>
                            </ul>
                          </div>

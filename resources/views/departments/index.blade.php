        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                  <h4 class="card-title">
                    All Production Departments <a href="{{ route('departments.create') }}" class="btn btn-sm btn-primary float-end"><i class="fa fa-plus"></i> Add New</a>
                  </h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li><a class="dropdown-item" href="{{ route('departments.show', $department->id) }}">View</a></li>
                              <li><a class="dropdown-item" href="{{ route('departments.edit', $department->id) }}">Edit</a></li>
                              <li><a class="dropdown-item" href="#!" onclick="callDeletItem('{{ $department->id }}', 'departments');">Delete</a></li>
                            </ul>
                          </div>
...
<script>
  $(document).ready(function() {
    var exportTitle = 'production-departments-data-export-' + Date.now();

...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-map-marker-alt"></i> Manage Site Locations</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                  <h4 class="card-title">
                    All Site Locations <a href="{{ route('site-locations.create') }}" class="btn btn-sm btn-primary float-end"><i class="fa fa-plus"></i> Add New</a>
                  </h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table class="table table-striped dt-responsive nowrap" id="dataTable" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="{{ route('site-locations.show', $site->id) }}">{{ $site->id }}</a></td>
                        <td>{{ $site->name }}</td>
                        <td>{{ $site->code }}</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li><a class="dropdown-item" href="{{ route('site-locations.show', $site->id) }}">View</a></li>
                              <li><a class="dropdown-item" href="{{ route('site-locations.edit', $site->id) }}">Edit</a></li>
                              <li><a class="dropdown-item" href="#!" onclick="callDeletItem('{{ $site->id }}', 'site-locations');">Delete</a></li>
                            </ul>
                          </div>
...
<script>
  $(document).ready(function() {
    var exportTitle = 'site-locations-data-export-' + Date.now();

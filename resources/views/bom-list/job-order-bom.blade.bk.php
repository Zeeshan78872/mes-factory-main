...
<script>
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $.each(response, function( index, bomItem ) {
          if(bomItem.item.bomcategory_id !== null) {
            if(bomItem.item.bomcategory_id !== lastCat) {
              // BOM Category Heading
              bomListHtmlData += `
              <tr data-bom-cat-id="${bomItem.item.bomcategory_id}" class="rowHeading">
                <td colspan="21" class="fs-5 text-white text-center bg-info">
                  <b>${bomItem.item.bom_category.name}</b>
                </td>
              </tr>`;
            }
            ...
            isBomCat = false;
            if(bomItem.item.parent_product === null) {
              ...
              <tr data-parent-product-id="${bomItem.item.id}" class="rowHeading">
                ...
                <td class="fs-6 text-white bg-secondary">
                  <input type="number" class="form-control" name="total_quantity[]" value="${bomItem.total_quantity}" required readonly>
                </td>
          ...
          <tr>
            ...
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm lengthInput" name="length[]" value="${bomItem.item.length ?? ''}" readonly>
                <span class="input-group-text">
                  <select class="form-select form-select-sm" id="length_unit" name="length_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                    <option></option>
            ...
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm widthInput" name="width[]" value="${bomItem.item.width ?? ''}" readonly>
                <span class="input-group-text">
                  <select class="form-select form-select-sm" id="width_unit" name="width_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                    <option></option>
            ...
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm thickInput" name="thick[]" value="${bomItem.item.thick ?? ''}" readonly>
                <span class="input-group-text">
                  <select class="form-select form-select-sm" id="thick_unit" name="thick_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                    <option></option>
            ...
            <td>
              <input type="number" class="form-control totalQtyInput" name="total_quantity[]" value="${bomItem.total_quantity ?? ''}" readonly required>
            </td>
            <td class="text-center">
              <select class="form-select form-select-sm" id="order_size_same_as_bom" name="order_size_same_as_bom[]" readonly style="pointer-events: none; background: #e9ecef;">
            ...
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm orderLengthInput" name="order_length[]" value="${bomItem.order_length ?? ''}" readonly>
                <span class="input-group-text">
                  <select class="form-select form-select-sm" id="length_unit" name="order_length_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                    <option></option>
                    ${currentLengthUnitHtml}
                  </select>
                </span>
            ...
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm orderWidthInput" name="order_width[]" value="${bomItem.order_width ?? ''}" readonly>
                <span class="input-group-text">
                  <select class="form-select form-select-sm" id="width_unit" name="order_width_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                    <option></option>
                    ${currentWidthUnitHtml}
                  </select>
                </span>
            ...
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm orderThickInput" name="order_thick[]" value="${bomItem.order_thick ?? ''}" readonly>
                <span class="input-group-text">
                  <select class="form-select form-select-sm" id="thick_unit" name="order_thick_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                    <option></option>
                    ${currentThickUnitHtml}
                  </select>
                </span>
            ...
            <td>
              <input type="number" class="form-control orderQtyInput" name="order_quantity[]" value="${bomItem.order_quantity ?? ''}" readonly>
            </td>
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm" name="location_receiving[]" value="${bomItem.location_receiving ?? ''}" readonly>
              </div>
            </td>
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm" name="location_produce[]" value="${bomItem.location_produce ?? ''}" readonly>
              </div>
            </td>
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm" name="location_loading[]" value="${bomItem.location_loading ?? ''}" readonly>
              </div>
            </td>
            <td>
              <div class="input-group input-group-sm">
                <input type="text" class="form-control form-control-sm" name="remarks[]" value="${bomItem.remarks ?? ''}" readonly>
              </div>
            </td>
            <td class="text-center">
  ...
  function populateInsideBomList(productData) {
    ...
    var isBomCat = true;
    if(productData.bomcategory_id !== null) {
      // BOM Category Heading
      var categoryHeading = `
      <tr data-bom-cat-id="${productData.bomcategory_id}" class="rowHeading">
        <td colspan="21" class="fs-5 text-white text-center bg-info">
          <b>${productData.bom_category.name}</b>
        </td>
      </tr>`;
    } else {
      isBomCat = false;
    ...
    var itemData = `
      <tr>
        ...
        <td>${productCodeForBom ?? "-" }</td>
        <td>
          <div class="input-group input-group-sm">
            <input type="text" class="form-control form-control-sm lengthInput" name="length[]" value="${productData.length ?? ''}" readonly>
            <span class="input-group-text">
              <select class="form-select form-select-sm" id="length_unit" name="length_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                <option></option>
                ${currentLengthUnitHtml}
        ...
        <td>
          <div class="input-group input-group-sm">
            <input type="text" class="form-control form-control-sm widthInput" name="width[]" value="${productData.width ?? ''}" readonly>
            <span class="input-group-text">
              <select class="form-select form-select-sm" id="width_unit" name="width_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                <option></option>
                ${currentWidthUnitHtml}
        ...
        <td>
          <div class="input-group input-group-sm">
            <input type="text" class="form-control form-control-sm thickInput" name="thick[]" value="${productData.thick ?? ''}" readonly>
            <span class="input-group-text">
              <select class="form-select form-select-sm" id="thick_unit" name="thick_unit[]" readonly style="pointer-events: none; background: #e9ecef;">
                <option></option>
                ${currentThickUnitHtml}
        ...
        <td>
          <input type="number" class="form-control totalQtyInput" name="total_quantity[]" value="${1 * jobOrderProductDetails.quantity}" required>
        </td>
        <td>
        ...
        <td>
          <div class="input-group input-group-sm">
            <input type="text" class="form-control form-control-sm orderLengthInput" name="order_length[]" value="${productData.order_length ?? ''}">
            <span class="input-group-text">
              <select class="form-select form-select-sm" id="length_unit" name="order_length_unit[]">
                <option></option>
                ${currentLengthUnitHtml}
        ...
        <td>
          <div class="input-group input-group-sm">
            <input type="text" class="form-control form-control-sm orderWidthInput" name="order_width[]" value="${productData.order_width ?? ''}">
            <span class="input-group-text">
              <select class="form-select form-select-sm" id="width_unit" name="order_width_unit[]">
                <option></option>
                ${currentWidthUnitHtml}
        ...
        <td>
          <div class="input-group input-group-sm">
            <input type="text" class="form-control form-control-sm orderThickInput" name="order_thick[]" value="${productData.order_thick ?? ''}">
            <span class="input-group-text">
              <select class="form-select form-select-sm" id="thick_unit" name="order_thick_unit[]">
                <option></option>
                ${currentThickUnitHtml}
      ...
      if(isBomCat) {
        var isHeadingExists = checkIfCategoryExists(productData.bomcategory_id);
      } else {
        var isHeadingExists = checkIfParentProductExists(productData.parent_product.id);
      }

...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-robot"></i> Manage Machines</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                  <h4 class="card-title">
                    All Machines <a href="{{ route('machines.create') }}" class="btn btn-sm btn-primary float-end"><i class="fa fa-plus"></i> Add New</a>
                  </h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table class="table table-striped dt-responsive nowrap" id="dataTable" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="{{ route('machines.show', $machine->id) }}">{{ $machine->id }}</a></td>
                        <td>{{ $machine->name }}</td>
                        <td>{{ $machine->code }}</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li><a class="dropdown-item" href="{{ route('machines.show', $machine->id) }}">View</a></li>
                              <li><a class="dropdown-item" href="{{ route('machines.edit', $machine->id) }}">Edit</a></li>
                              <li><a class="dropdown-item" href="{{ route('system.settings.qr.generator', $machine->id) }}" target="_blank">Genrate QR Code</a></li>
                              <li><a class="dropdown-item" href="#!" onclick="callDeletItem('{{ $machine->id }}', 'machines');">Delete</a></li>
                            </ul>
                          </div>
